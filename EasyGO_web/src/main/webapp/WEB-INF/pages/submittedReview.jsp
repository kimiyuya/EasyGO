...
<head lang="en">
    ...
    <script type="text/javascript">
        ...
        function back() {
            location.href='/to_choose_car';  //跳转到choose_car
        }
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
                        ...
                        <h3>Thank you</h3>
                        <%--<input type="button" class="btn btn-primary btn-block" onclick="back()"--%>
                               <%--value="BACK">--%>
                        <button type="button" class="btn btn-primary btn-block" onclick="javascript:window.history.go(-2);"> back </button>
                    </div>
                </div>
            </div>
        </div>
